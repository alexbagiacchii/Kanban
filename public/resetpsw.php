...
<body>
	...
	padding-bottom: 15px;">Username inesistente</p>
				...
				<div id="btnUsername">
					<button type="button" onclick="cercaUtente()" class="btn">Cerca</button>
				</div>
	...
	<script>
		async function cercaUtente() {
			...
			const response = await fetch("../private/check_user.php?username=" + username);
		...
		async function resetPassword() {
			...
			form.setAttribute("action", "../private/resetpsw.php");
